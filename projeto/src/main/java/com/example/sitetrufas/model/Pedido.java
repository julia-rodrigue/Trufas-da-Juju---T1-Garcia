...
public class Pedido {
    ...
    // SELECT
    public Pedido(String id, String usuarioId, String nomeCliente, String telefone, String formaPagamento, String dataRetirada, String status){
        this.id = id;
    ...
    public static Pedido converter(Map<String, Object> registro){
        ...
        UUID usuarioId      = (UUID)   registro.get("usuario_id");
        ...
        return new Pedido(id.toString(), usuarioId != null ? usuarioId.toString() : null, nomeCliente, telefone, formaPag, dataRetirada, status);
    }
